      ...
      <div className="card shadow-2xl my-2">
        ...
        <div className="card-body font-poppins -m-4">
          ...
          <div className="justify-center card-actions">
            ...
            <button to="#my-modal" className="btn bg-dark-green hover:btn-accent border-0 w-full" >beli sekarang</button> 
            <div id="my-modal" className="modal">
              <div className="modal-box bg-light-green">
                ...
                <div className="modal-action">
                  <Link to="/payment">
                    <button to="#" className="btn btn-accent" onClick={handleCheckout}>Ya</button> 
                  </Link>
                  <button to="#" className="btn">Tidak</button> 
                </div>
              </div>
            </div> 
          </div>
