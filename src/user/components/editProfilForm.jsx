...
export default function EditProfil() {
  ...
  <div className="bg-light-green font-poppins p-3 lg:p-12 rounded-lg">
    ...
    <form className="w-full mx-auto my-5 text-black">
      ...
      <button to="#my-modal" className="btn bg-dark-green hover:btn-accent border-0 w-full" >simpan</button> 
      <div id="my-modal" className="modal">
        <div className="modal-box bg-light-green">
          ...
          <div className="modal-action">
            <button to="#" className="btn btn-accent" onClick={handleFormSubmit}>Masuk</button> 
            <button to="#" className="btn">Tutup</button> 
          </div>
        </div>
      </div>   
    </form>
