...
export default function Navbar() {
  ...
  const [fiturOpen, setFiturOpen] = useState(false)
	return (
		<>
      <nav className="font-montserrat sticky top-0 inset-x-0 z-20 flex flex-wrap items-center justify-between px-2 py-3 bg-white shadow-md">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            ...
            >
              <svg className="w-6 h-6" fill="#6abf69" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd" /></svg>
            </button>
          </div>
          <div
            className={
              ...
              <li className="nav-item hidden lg:block">
                ...
                >
                  ...
                  <ul tabIndex="0" className="shadow menu dropdown-content bg-white rounded-box w-52 text-sm py-0">
                    ...
                    <li className='hover:bg-light-green -mt-3'>
                      <Link to="/deteksi">Test Tingkat Stress</Link>
                    </li> 
                    <li className='hover:bg-light-green -mt-3'>
